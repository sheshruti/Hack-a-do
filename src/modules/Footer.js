...
const Footer = () => {
  return (
	<footer className="bg-neutral-900 text-center bg-[#2883d2] text-white w-[100%] ">
  <div className="container px-6 pt-6 ">
    <div className="mb-6 flex justify-center">
      <a
        href="#!"
        type="button"
        className="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-[#2883d2] hover:bg-opacity-5 focus:outline-none focus:ring-0"
        data-te-ripple-init
      ...
      <form action="">
        <div
          ...
          <div className="relative md:mb-6" data-te-input-wrapper-init>
            <input
              type="text"
              className="peer block border-solid min-h-[auto] w-full rounded  border-white-600 bg- py-[0.32rem] px-3 leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
