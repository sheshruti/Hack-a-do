...
const Form = () => {
  return (
	<div>
		<section className="gradient-form h-full bg-[#dfecf0] dark:bg-[#43bfc7]-300 flex justify-center">
  <div className="container h-full p-10">
    <div
      className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
      <div className="w-full">
        <div
          className="block rounded-lg bg-gradient-to-r from-[#2883d2] to-[#00baff] shadow-lg">
